...
public class SearchListActivity extends BaseActivity{
    ...
    public void initComponent() {
        ...
        sort_bar.setOnTouchSortListener(new SortBar.OnTouchSortListener() {

            View layoutView = LayoutInflater.from(SearchListActivity.this).inflate(R.layout.dialog_search_list_prompt, null);
