...
public class SettingListener implements ISetting {
	...
	public void vRetCustomCmd(int contactId, int len, byte[] cmd) {
		...
		long time = SharedPreferencesManager.getInstance().getIgnoreAlarmTime(MyApp.app.getApplicationContext());
		int time_interval = SharedPreferencesManager.getInstance().getAlarmTimeInterval(MyApp.app.getApplicationContext());
