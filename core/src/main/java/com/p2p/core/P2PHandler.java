...
//	}
	...
	public void playbackConnect(String contactId, String password,
		...
		MediaPlayer.getInstance().native_p2p_call(Integer.parseInt(contactId),
				...
				Integer.parseInt(password), recordFilePosition, AppConfig.VideoMode,byt,
				"".getBytes(), "gwell");
	}
    ...
    public void controlCamera(String contactId,String password,byte[]data){
		...
		int iId = Integer.parseInt(contactId);
		MediaPlayer.iExtendedCmd(iId, Integer.parseInt(password), this.CONTROL_CAMERA,
	...
	public int GetAllarmImage(String id,String password,String filename,String localName){
		return MediaPlayer.GetAllarmImage(Integer.parseInt(id), Integer.parseInt(password), filename, localName);
	}
	/**
	 * 获取图片的进度
	 * @return
